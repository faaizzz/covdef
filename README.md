...
Run `ng deploy --base-href="https://faaizzz.github.io/covdef/"` to deploy the project. The build will be deployed to [Covid Defender](https://faaizzz.github.io/covdef/).
